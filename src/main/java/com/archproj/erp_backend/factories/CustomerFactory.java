...
public class CustomerFactory {
    ...
    public static Customer createCustomer(Long id, CustomerTypeEnum type, String name, String email) {
        if (type == CustomerTypeEnum.CORPORATE) {
            return new CorporateCustomer(id, name, email);
        } else if (type == CustomerTypeEnum.INDIVIDUAL) {
            return new IndividualCustomer(id, name, email);
        }
